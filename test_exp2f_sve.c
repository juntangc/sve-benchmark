...
int main()
{
    ...
    for(int b =0; b < batch; b++)
    {
        ...
        {
            int idx = b * width + w;
            if((fabsf(exp2f(src_data[idx]) - dst_data2[idx]) > 1.e-5f) && (b == 0))
                printf("%d %d %f %f %f %f %f\n", b, w, src_data[idx], 
                exp2f(src_data[idx]), optr_aor_gcc_exp2_f32(src_data[idx]), 
